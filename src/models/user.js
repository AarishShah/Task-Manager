...
userSchema.virtual('tasks', // any name would do --- virtaul tell mongoose how these two things are related --- note: this needed to be same as ref, altho Andrew said that it was not the case
    {
        ref: 'tasks', // reference is with Task, this is also case-sensitive
        ...
        foreignField: 'owner' // name of the other field which is relating the data of tasks with users
    }
)
